...
@section('content')
            ...
            <main role="main" class="main-content">
                <div class="container-fluid">
                    ...
                    <div class="row my-4">
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4 shadow cursor-pointer" data-toggle="modal" data-target="#mitigationModal">
                                <div class="card-body my-n3">
                                    <div class="text-center py-3 my-2">
                                        <span class="circle bg-light" style="width:120px;height:120px">
                                        ...
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col pr-0">
                                                    ...
                                                    <span class="h3 mb-0">{{ $userCount }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card shadow border-0">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col pr-0">
                                                    <p class="small text-muted mb-0">Berita</p>
                                                    <span class="h3 mb-0">{{ $blogCount }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card shadow border-0">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col pr-0">
                                                    <p class="small text-muted mb-0">Grup</p>
                                                    <span class="h3 mb-0">{{ $grupCount }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card shadow border-0">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col pr-0">
                                                    <p class="small text-muted mb-0">Tugas</p>
                                                    <span class="h3 mb-0">{{ $taskCount }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal fade" id="mitigationModal" tabindex="-1" aria-labelledby="ebookModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ebookModalLabel">Dampak</h5>
